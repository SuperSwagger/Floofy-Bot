...
module.exports = class WeatherCommand extends Command {
	...
	async run(msg, args) {
		...
		if (!config.GoogleAPIKey) return msg.reply('my Commander has not set the Google API Key. Go yell at her.');
		if (!config.WeatherAPIKey) return msg.reply('my Commander has not set the Weather API Key. Go yell at her.');
	...
	getBase(icon) {
		if (icon === 'clear-day' || icon === 'partly-cloudy-day') return path.join(__dirname, '..', '..', 'assets', 'weather', 'base', 'day.png');
		else if (icon === 'clear-night' || icon === 'partly-cloudy-night') return path.join(__dirname, '..', '..', 'assets', 'weather', 'base', 'night.png');
		else if (icon === 'rain') return path.join(__dirname, '..', '..', 'assets', 'weather', 'base', 'rain.png');
		else if (icon === 'thunderstorm') return path.join(__dirname, '..', '..', 'assets', 'weather', 'base', 'thunderstorm.png');
		else if (icon === 'snow' || icon === 'sleet' || icon === 'fog') return path.join(__dirname, '..', '..', 'assets', 'weather', 'base', 'snow.png');
		else if (icon === 'wind' || icon === 'tornado') return path.join(__dirname, '..', '..', 'assets', 'weather', 'base', 'windy.png');
		else if (icon === 'cloudy')	return path.join(__dirname, '..', '..', 'assets', 'weather', 'base', 'cloudy.png');
		else return path.join(__dirname, '..', '..', 'assets', 'weather', 'base', 'cloudy.png');
	}
};
