...
exports.run = async (bot, message) => { // eslint-disable-line
	...
	*/
	...
	if (cmd === 'nicememe') {
		...
		message.channel.send('http://prntscr.com/buz1mq');
	}
	else if (cmd === 'awoo') {
		...
		message.channel.send('http://oddshot.tv/shot/mcdareth-2016030521458263');
	}
	else if (cmd === 'aura') {
		...
		message.channel.send('https://gfycat.com/ImpoliteSinfulBuzzard');
	}
